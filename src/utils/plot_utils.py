...
def setup_mpl(as_default=1, font="en"):  # My mpl setup
    if as_default:
        ...
        mpl.rcParams["xtick.major.width"] = 2 / 3.0  # 0.8
        mpl.rcParams["ytick.major.width"] = 2 / 3.0
        mpl.rcParams["xtick.minor.width"] = 2 / 3.0  # 0.6
        mpl.rcParams["ytick.minor.width"] = 2 / 3.0
        ...
        #
        mpl.rcParams["axes.linewidth"] = 2 / 3.0  # 0.8
